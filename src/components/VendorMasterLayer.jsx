...
const VendorMasterLayer = () => {
  ...
  const loadVendors = async (page = 1, resetPage = false, append = false) => {
    try {
      ...
      const result = await vendorMasterApi.getAllVendors(
        targetPage,
        20,
        options
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (error.result) {
        ...
        setFormErrors({
          general:
            error.message || "Failed to add/update vendor. Please try again.",
        });
      }
    } finally {
      ...
      {totalRecords > 0 && (
        ...
        >
          <div style={{ fontSize: "0.875rem", color: "#6c757d" }}>
            Showing <strong>{getDisplayedData(vendors).length}</strong> of{" "}
            <strong>{totalRecords}</strong> vendors
          </div>
          {hasMoreData(vendors) && (
            <div style={{ fontSize: "0.875rem", color: "#6c757d" }}>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="row">
                    <div className="col-md-6 mb-3">
                      ...
                      <input
                        ...
                        className={`form-control ${
                          formErrors.vendorName ? "is-invalid" : ""
                        }`}
                        id="vendorName"
                        name="vendorName"
                    ...
                    <div className="col-md-6 mb-3">
                      <label htmlFor="vendorPhoneNo" className="form-label">
                        Vendor Phone No. <span className="text-danger">*</span>
                      </label>
                      <input
                        type="tel"
                        className={`form-control ${
                          formErrors.vendorPhoneNo ? "is-invalid" : ""
                        }`}
                        id="vendorPhoneNo"
                        name="vendorPhoneNo"
                  ...
                  <div className="row">
                    <div className="col-md-6 mb-3">
                      <label htmlFor="vendorGSTNumber" className="form-label">
                        Vendor GST Number <span className="text-danger">*</span>
                      </label>
                      <input
                        type="text"
                        className={`form-control ${
                          formErrors.vendorGSTNumber ? "is-invalid" : ""
                        }`}
                        id="vendorGSTNumber"
                  ...
                  <div className="row">
                    <div className="col-md-6 mb-3">
                      ...
                      <textarea
                        className={`form-control ${
                          formErrors.vendorAddress ? "is-invalid" : ""
                        }`}
                        id="vendorAddress"
                        name="vendorAddress"
                        rows="3"
                    ...
                    <div className="col-md-6 mb-3">
                      ...
                      <select
                        className={`form-select ${
                          formErrors.vendorStatus ? "is-invalid" : ""
                        }`}
                        id="vendorStatus"
                        name="vendorStatus"
